...
char temperature[80] = "134";
  char pressure[80] = "1584";
  char altitude[80] = "153";
  char humidity[80] = "123";

  void pullCharArr(){
    dtostrf(enviornment_temp, 1, 2, temperature);
  dtostrf(enviornment_pressure, 1, 2, pressure);
  dtostrf(enviornment_altitude, 1, 2, altitude);
  dtostrf(enviornment_humidity, 1, 2, humidity);
  }
...
Serial.println("Connecting to Database...");                //Inform user that the system is now trying to connect to the database
  ...
  // char temperature[8] = "134";
  // char pressure[8] = "1584";
  // char altitude[8] = "153";
  // char humidity[8] = "123";
  ...
  bool databaseonline = conn.connect(servaddress, 3306, "sql9596235", "7LCYhZVIwK");

  if (databaseonline) {      //if the connection to the database at the specified location is true...

                                                 //delay for 1 second                         //print statement to check if it made it to this part of the loop
  ...
  Serial.println("Connection failed.");                //connection has failed if it reaches this else statement

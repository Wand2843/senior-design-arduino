...
*/
    ...
    writeTxt(0, 80 + 70 * 2, charControllerTemperatureArray, RA8875_WHITE, 1, 1);
...
*/
    ...
    writeTxt(0, 80, charSolarPanelVoltageArray, RA8875_WHITE, 1, 1);
    writeTxt(0, 80 + 70 * 1, charSolarPanelAmpsArray, RA8875_WHITE, 1, 1);
    writeTxt(0, 80 + 70 * 2, charSolarPanelWattsArray, RA8875_WHITE, 1, 1);
